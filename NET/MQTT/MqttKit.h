...
enum MqttPacketType
{
    ...
    MQTT_PKT_CONNECT = 1, /**< 连接请求数据包 *///客户端请求与服务端建立连接
    MQTT_PKT_CONNACK,     /**< 连接确认数据包 *///服务端确认连接建立
    MQTT_PKT_PUBLISH,     /**< 发布数据数据包 *///发布消息
    MQTT_PKT_PUBACK,      /**< 发布确认数据包 *///收到发布消息确认
    MQTT_PKT_PUBREC,      /**< 发布数据已接收数据包，Qos 2时，回复MQTT_PKT_PUBLISH *///发布消息收到
    MQTT_PKT_PUBREL,      /**< 发布数据释放数据包， Qos 2时，回复MQTT_PKT_PUBREC *///发布消息释放
    MQTT_PKT_PUBCOMP,     /**< 发布完成数据包， Qos 2时，回复MQTT_PKT_PUBREL *///发布消息完成
    MQTT_PKT_SUBSCRIBE,   /**< 订阅数据包 *///订阅请求
    MQTT_PKT_SUBACK,      /**< 订阅确认数据包 *///订阅确认
    MQTT_PKT_UNSUBSCRIBE, /**< 取消订阅数据包 *///取消订阅
    MQTT_PKT_UNSUBACK,    /**< 取消订阅确认数据包 *///取消订阅确认
    MQTT_PKT_PINGREQ,     /**< ping 数据包 *///客户端发送PING(连接保活)命令
    MQTT_PKT_PINGRESP,    /**< ping 响应数据包 *///PING命令回复
    MQTT_PKT_DISCONNECT,  /**< 断开连接数据包 *///断开连接
